module.exports = {
    ...
    "containerDefinitions": [
        {
            "name": "gepitemtagsmanager-0044",
            "image": `${process.env.AWS_ACCOUNT_ID}.dkr.ecr.us-east-1.amazonaws.com/geppetto-generatedcode-functioninc-0044-gepitemtagsmanager:latest`,
